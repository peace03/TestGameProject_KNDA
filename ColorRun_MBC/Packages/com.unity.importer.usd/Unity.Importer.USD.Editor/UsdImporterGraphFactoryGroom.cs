...
namespace UnityEditor.Importer.USD
{
    ...
    /// </summary>
    public class UsdImporterGraphFactoryGroom
    {
        /// <summary>
        /// Create a default in-memory <see cref="ImporterGraph"/> for importing usd files.
        /// </summary>
        /// <returns></returns>
        public static ImporterGraph CreateGroomGraph()
        {
...
#if HAIR_0_OR_HIGHER
            //Hair
            var getTfTypeByNameNode_basisCurve_hair = new GetTfTypeByNameNode();
            var filterStageByTfTypeNode_basisCurve_hair = new FilterStageByTfTypeNode();
            var getTfTypeByNameNode_nurbsCurve_hair = new GetTfTypeByNameNode();
            var filterStageByTfTypeNode_nurbsCurve_hair = new FilterStageByTfTypeNode();
            var sampleNurbsCurveNode_hair = new SampleNurbsCurvesNode();
            var sampleBasisCurveNode_hair = new SampleBasisCurvesNode();
            var curveDescriptionAggregator_hair = new IDictionaryAggregatorNode<Dictionary<string, CurvesDescription>>();
            var createHairNode_hair = new CreateHairNode();
            var primAggregator_xform_hair = new IListAggregatorNode<List<UsdPrim>>();
            var readReferencesNode_hair = new ReadReferencesNode();
            var readXformNode_hair = new ReadXFormNode();
            var createXformNode_hair = new CreateXFormNode();
            var addHairInstanceToGameObjectsNode_hair = new AddHairInstanceToGameObjectsNode();
#endif
...
#if HAIR_0_OR_HIGHER
            //Hair
            graph.AddNode(getTfTypeByNameNode_basisCurve_hair);
            graph.AddNode(filterStageByTfTypeNode_basisCurve_hair);
            graph.AddNode(getTfTypeByNameNode_nurbsCurve_hair);
            graph.AddNode(filterStageByTfTypeNode_nurbsCurve_hair);
            graph.AddNode(sampleNurbsCurveNode_hair);
            graph.AddNode(sampleBasisCurveNode_hair);
            graph.AddNode(curveDescriptionAggregator_hair);
            graph.AddNode(createHairNode_hair);
            graph.AddNode(primAggregator_xform_hair);
            graph.AddNode(readReferencesNode_hair);
            graph.AddNode(readXformNode_hair);
            graph.AddNode(createXformNode_hair);
            graph.AddNode(addHairInstanceToGameObjectsNode_hair);
#endif
...
#if HAIR_0_OR_HIGHER
            graph.AddImportSetting(new ImportSetting<SamplesPerStrandSetting>(UsdImporterImportSettings.SamplesPerStrandSetting, new SamplesPerStrandSetting {value = 8}));
#endif
            ...
            //getTfTypeByNameNode_basisCurve_hair
            graph.AddImportConstant(new ImportConstant<string>("UsdGeomBasisCurves", getTfTypeByNameNode_basisCurve_hair, nameof(GetTfTypeByNameNode.Input.tfTypeName)));

            //filterStageByTfTypeNode_basisCurve_hair
            graph.AddEdge(new Edge(usdStageOpenNode_stage, nameof(UsdStageOpenNode.Output.stage), filterStageByTfTypeNode_basisCurve_hair, nameof(FilterStageByTfTypeNode.Input.stage)));
            graph.AddEdge(new Edge(getTfTypeByNameNode_basisCurve_hair, nameof(GetTfTypeByNameNode.Output.tfType), filterStageByTfTypeNode_basisCurve_hair, nameof(FilterStageByTfTypeNode.Input.tfType)));

            //getTfTypeByNameNode_nurbsCurve_hair
            graph.AddImportConstant(new ImportConstant<string>("UsdGeomNurbsCurves", getTfTypeByNameNode_nurbsCurve_hair, nameof(GetTfTypeByNameNode.Input.tfTypeName)));

            //filterStageByTfTypeNode_nurbsCurve_hair
            graph.AddEdge(new Edge(usdStageOpenNode_stage, nameof(UsdStageOpenNode.Output.stage), filterStageByTfTypeNode_nurbsCurve_hair, nameof(FilterStageByTfTypeNode.Input.stage)));
            graph.AddEdge(new Edge(getTfTypeByNameNode_nurbsCurve_hair, nameof(GetTfTypeByNameNode.Output.tfType), filterStageByTfTypeNode_nurbsCurve_hair, nameof(FilterStageByTfTypeNode.Input.tfType)));

            //sampleNurbsCurveNode_hair
            graph.AddSettingEdge(new SettingEdge(UsdImporterImportSettings.SamplesPerStrandSetting, sampleNurbsCurveNode_hair, nameof(SampleNurbsCurvesNode.Input.samplesPerStrand)));
            graph.AddEdge(new Edge(filterStageByTfTypeNode_nurbsCurve_hair, nameof(FilterStageByTfTypeNode.Output.primList), sampleNurbsCurveNode_hair, nameof(SampleNurbsCurvesNode.Input.prims)));
            graph.AddEdge(new Edge(extractUsdStageMetadataNode_stage, nameof(ExtractUsdStageMetadataNode.Output.usdMetadata), sampleNurbsCurveNode_hair, nameof(SampleNurbsCurvesNode.Input.usdMetadata)));

            //sampleBasisCurveNode_hair
            graph.AddSettingEdge(new SettingEdge(UsdImporterImportSettings.SamplesPerStrandSetting, sampleBasisCurveNode_hair, nameof(SampleBasisCurvesNode.Input.samplesPerStrand)));
            graph.AddEdge(new Edge(filterStageByTfTypeNode_basisCurve_hair, nameof(FilterStageByTfTypeNode.Output.primList), sampleBasisCurveNode_hair, nameof(SampleBasisCurvesNode.Input.prims)));
            graph.AddEdge(new Edge(extractUsdStageMetadataNode_stage, nameof(ExtractUsdStageMetadataNode.Output.usdMetadata), sampleBasisCurveNode_hair, nameof(SampleBasisCurvesNode.Input.usdMetadata)));

            //curveDescriptionAggregator_hair
            graph.AddEdge(new Edge(sampleNurbsCurveNode_hair, nameof(SampleNurbsCurvesNode.Output.curveData), curveDescriptionAggregator_hair, nameof(IDictionaryAggregatorNode<Dictionary<string, CurvesDescription>>.Input.inputs_0)));
            graph.AddEdge(new Edge(sampleBasisCurveNode_hair, nameof(SampleBasisCurvesNode.Output.curveData), curveDescriptionAggregator_hair, nameof(IDictionaryAggregatorNode<Dictionary<string, CurvesDescription>>.Input.inputs_1)));

            //createHairNode_hair
            graph.AddSettingEdge(new SettingEdge(UsdImporterImportSettings.SamplesPerStrandSetting, createHairNode_hair, nameof(CreateHairNode.Input.samplesPerStrand)));
            graph.AddEdge(new Edge(curveDescriptionAggregator_hair, nameof(IDictionaryAggregatorNode<Dictionary<string, CurvesDescription>>.Output.output), createHairNode_hair, nameof(CreateHairNode.Input.curveData)));

            //primAggregator_xform_hair
            graph.AddEdge(new Edge(filterStageByTfTypeNode_nurbsCurve_hair, nameof(FilterStageByTfTypeNode.Output.primList), primAggregator_xform_hair, nameof(IListAggregatorNode<List<UsdPrim>>.Input.inputs_0)));
            graph.AddEdge(new Edge(filterStageByTfTypeNode_basisCurve_hair, nameof(FilterStageByTfTypeNode.Output.primList), primAggregator_xform_hair, nameof(IListAggregatorNode<List<UsdPrim>>.Input.inputs_1)));

            //readReferencesNode_hair
            graph.AddEdge(new Edge(primAggregator_xform_hair, nameof(IListAggregatorNode<List<UsdPrim>>.Output.output), readReferencesNode_hair, nameof(ReadReferencesNode.Input.prims)));

            //readXformNode_hair
            graph.AddEdge(new Edge(primAggregator_xform_hair, nameof(IListAggregatorNode<List<UsdPrim>>.Output.output), readXformNode_hair, nameof(ReadXFormNode.Input.prims)));
            graph.AddEdge(new Edge(extractUsdStageMetadataNode_stage, nameof(ExtractUsdStageMetadataNode.Output.usdMetadata), readXformNode_hair, nameof(ReadXFormNode.Input.usdMetadata)));

            //createXformNode_hair
            graph.AddEdge(new Edge(readXformNode_hair, nameof(ReadXFormNode.Output.xFormableDescriptions), createXformNode_hair, nameof(CreateXFormNode.Input.xFormableDescriptions)));

            //addHairInstanceToGameObjectsNode_hair
            graph.AddEdge(new Edge(createHairNode_hair, nameof(CreateHairNode.Output.hairAssets), addHairInstanceToGameObjectsNode_hair, nameof(AddHairInstanceToGameObjectsNode.Input.hairAssets)));
            graph.AddEdge(new Edge(createXformNode_hair, nameof(CreateXFormNode.Output.gameObjects), addHairInstanceToGameObjectsNode_hair, nameof(AddHairInstanceToGameObjectsNode.Input.gameObjects)));
            graph.AddEdge(new Edge(readReferencesNode_hair, nameof(ReadReferencesNode.Output.objsToRefs), addHairInstanceToGameObjectsNode_hair, nameof(AddHairInstanceToGameObjectsNode.Input.objsToRefs)));
#endif
...
#if HAIR_0_OR_HIGHER
            graph.AddEdge(new Edge(addHairInstanceToGameObjectsNode_hair, nameof(AddHairInstanceToGameObjectsNode.Output.gameObjects),
                aggregator_entry_hierarchy, nameof(IDictionaryAggregatorNode<Dictionary<string, GameObject>>.Input.inputs_8)));
#endif
...
#if HAIR_0_OR_HIGHER
            graph.AddResultEdge(new ResultEdge(nameof(CreateHairNode.Output.hairAssets), createHairNode_hair, nameof(CreateHairNode.Output.hairAssets)));
            graph.AddResultEdge(new ResultEdge(nameof(CreateHairNode.Output.hairMeshAssetRoots), createHairNode_hair, nameof(CreateHairNode.Output.hairMeshAssetRoots)));
            graph.AddResultEdge(new ResultEdge(nameof(CreateHairNode.Output.hairMeshAssetLines), createHairNode_hair, nameof(CreateHairNode.Output.hairMeshAssetLines)));
            graph.AddResultEdge(new ResultEdge(nameof(CreateHairNode.Output.hairMeshAssetStrips), createHairNode_hair, nameof(CreateHairNode.Output.hairMeshAssetStrips)));
#endif
            return graph;
        }
